                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            <form role="form text-left" method="POST" action="<?= base_url('Penyuluh/PenyuluhPns/save/'); ?>">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <select name="tingkat_pendidikan" id="tingkat_pendidikan" class="form-control input-lg tingkat_pendidikan">
                                                                ...
                                                                foreach ($tingkatpen as $row4) {
                                                                    echo '<option value="' . $row4["nama"] . '">' . $row4["nama"] . '</option>';
                                                                }
                                                                ?>
                                                            </select>
                                                        </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            <form method="POST" action="<?= base_url('Penyuluh/PenyuluhPns/updatestatus'); ?>">
                                                <? csrf_field(); ?>
                                                <div class="row">
                                                    <div class="col">
                                                        <input type="hidden" name="id" id="id" class="form-control id">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <select id="day4" name="tgl_status" class="form-select tgl_status" aria-label="Default select example">
                                                                <option value="">Tanggal</option>
                                                            </select>
                                                            <select id="month4" name="tgl_status" class="form-select tgl_status" aria-label="Default select example">
                                                                <option value="">Bulan</option>
                                                            </select>
                                                            <select id="year4" name="tgl_status" class="form-select tgl_status" aria-label="Default select example">
                                                                <option value="">Tahun</option>
                                                            </select>
                                                        </div>
                                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).delegate('#btnSave', 'click', function() {
                ...
                $.ajax({
                    url: '<?= base_url() ?>/Penyuluh/PenyuluhPns/save/',
                    type: 'POST',
                    data: {
                        'nip': nip,
                        'nama': nama,
            ...
            $(document).delegate('#btnHapus', 'click', function() {
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: '<?= base_url() ?>/Penyuluh/PenyuluhPns/delete/' + id,
                            type: 'POST',
            ...
            $(document).delegate('#btnEdit', 'click', function() {
                $.ajax({
                    url: '<?= base_url() ?>/Penyuluh/PenyuluhPns/edit/' + $(this).data('id'),
                    type: 'GET',
                    dataType: 'JSON',
                    success: function(result) {
                        // console.log(result);
                        ...
                        $(document).delegate('#btnDoEdit', 'click', function() {
                            ...
                            $.ajax({
                                url: '<?= base_url() ?>/Penyuluh/PenyuluhPns/update/' + id,
                                type: "POST",
                                data: formData,
                                cache: false,
                                processData: false,
            ...
            $('.tempat_tugas').on('change', function() {
                ...
                $.ajax({
                    url: "<?= base_url() ?>/Penyuluh/PenyuluhPns/showDesa/" + kdtempat_tugas + "",
