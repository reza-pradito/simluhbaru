...
<center>
    <h4> Rekap Ketenagaan Penyuluhan Tingkat Nasional </h4><br>
</center>
        ...
        <table class="table align-items-center mb-0">
            ...
            <tbody>
                <tr>
                    ...
                    <td align=left size=2 class="align-middle text-center text-sm">BPPSDMP</td>
                    <td align=right size=2 class="align-middle text-center text-sm">
                        <a href="<?= base_url('/BppsdmpAktif') ?>" style="color: blue;">
                            <?= $jum_pusat; ?>
                        </a>
                    </td>
                    <td align=left size=2 class="align-middle text-center text-sm"><?= $jum_pusatTB; ?> </td>
                    ...
                    <td align=right size=2 class="align-middle text-center text-sm">0</td>
                    <td align=right size=2 class="align-middle text-center text-sm">0</td>
                    <td align=right size=2 class="align-middle text-center text-sm"><?= $jum_pusat + $jum_pusatTB; ?></td>
                </tr>
                <tr>
                    <td align=center size=2 class="align-middle text-center text-sm">2</td>
                    <td align=left size=2 class="align-middle text-center text-sm">BBP2TP</td>
                    <td align=right size=2 class="align-middle text-center text-sm">
                        <a href="<?= base_url('/Bp2tpAktif') ?>" style="color: blue;">
                            <?= $jum_bp2tp; ?>
                        </a>
                    </td>
                    <td align=left size=2 class="align-middle text-center text-sm"><?= $jum_bp2tp_TB; ?> </td>
                    <td align=right size=2 class="align-middle text-center text-sm">0</td>
                    <td align=right size=2 class="align-middle text-center text-sm">0</td>
                    <td align=right size=2 class="align-middle text-center text-sm">0</td>
                    <td align=right size=2 class="align-middle text-center text-sm">0</td>
                    <td align=right size=2 class="align-middle text-center text-sm">0</td>
                    <td align=right size=2 class="align-middle text-center text-sm">0</td>
                    <td align=right size=2 class="align-middle text-center text-sm"><?= $jum_bp2tp + $jum_bp2tp_TB; ?></td>
                </tr>
                <?php
                $i = 3;
                $jumpns = 0;
                ...
                ?>
                    <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                            <a href="<?= base_url('/dk_prop?kode_prop=' . $item['id_prop']) ?>" style="color: blue;">
