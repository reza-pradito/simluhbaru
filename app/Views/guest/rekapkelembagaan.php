        ...
        <table class="table align-items-center mb-0">
            <thead>
                <tr>
                    ...
                    <td width="100" class="text-uppercase text-secondary text-xxs font-weight-bolder" align="center">Nama Kelembagaan</td>
                    <td width="120" class="text-uppercase text-secondary text-xxs font-weight-bolder" style="text-align: center;">Peraturan</td>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                            <a href="<?= base_url('/rkp_bpp?kode_prop=' . $item['kode_prop']) ?>" style="color: blue;">
