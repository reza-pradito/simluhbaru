            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                            <a href="<?= base_url('/sarpras_kab?kode_prop=' . $item['id_prop']) ?>" style="color: blue;">
                                <p class="text-xs font-weight-bold mb-0" style="text-align: left;"><?= $item['nama_prop'] ?></p>
                            </a>
                        </td>
                        <td class="align-middle text-sm" align="center">
                            <p class="text-xs font-weight-bold mb-0"><?= $r4apbn = $item['r4_apbnp'] + $item['r4_apbnk'] + $item['r4_apbnb']; ?></p>
                        </td>
                        <td class="align-middle text-sm" align="center">
                            <p class="text-xs font-weight-bold mb-0"><?= $r4apbd = $item['r4_apbdp'] + $item['r4_apbdk'] + $item['r4_apbdb']; ?></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0"><?= $r2apbn = $item['r2_apbnp'] + $item['r2_apbnk'] + $item['r2_apbnb']; ?></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0"><?= $r2apbd = $item['r2_apbdp'] + $item['r2_apbdk'] + $item['r2_apbdb']; ?></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0"><?= $pcapbn = $item['pc_apbnp'] + $item['pc_apbnk'] + $item['pc_apbnb']; ?></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0"><?= $pcapbd = $item['pc_apbdp'] + $item['pc_apbdk'] + $item['pc_apbdb']; ?></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0"><?= $laptopapbn = $item['laptop_apbnp'] + $item['laptop_apbnk'] + $item['laptop_apbnb']; ?></p>
                        </td>
                        <td class="align-middle text-sm" align="center">
                            <p class="text-xs font-weight-bold mb-0"><?= $laptopapbd = $item['laptop_apbdp'] + $item['laptop_apbdk'] + $item['laptop_apbdb']; ?></p>
                        </td>
                        <td class="align-middle text-sm" align="center">
                            <p class="text-xs font-weight-bold mb-0"><?= $printerapbn = $item['printer_apbnp'] + $item['printer_apbnk'] + $item['printer_apbnb']; ?></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0"><?= $printerapbd = $item['printer_apbdp'] + $item['printer_apbdk'] + $item['printer_apbdb']; ?></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0"><?= $modemapbn = $item['modem_apbnp'] + $item['modem_apbnk'] + $item['modem_apbnb']; ?></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0"><?= $modemapbd = $item['modem_apbdp'] + $item['modem_apbdk'] + $item['modem_apbdb']; ?></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0"><?= $lcdapbn = $item['lcd_apbnp'] + $item['lcd_apbnk'] + $item['lcd_apbnb']; ?></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0"><?= $lcdapbd = $item['lcd_apbdp'] + $item['lcd_apbdk'] + $item['lcd_apbdb']; ?></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0"><?= $soilapbn = $item['soil_apbnp'] + $item['soil_apbnk'] + $item['soil_apbnb']; ?></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0"><?= $soilapbd = $item['soil_apbdp'] + $item['soil_apbdk'] + $item['soil_apbdb']; ?></p>
                        </td>
