...
class KabupatenModel extends Model
{
    ...
    protected $allowedFields = [
        ...
        'perda', 'pergub', 'id_gapoktan', 'nama_bapel', 'dasar_hukum', 'no_peraturan', 'tgl_berdiri', 'bln_berdiri', 'thn_berdiri', 'telp_kantor', 'alamat',  'email', 'website', 'ketua', 'telp_hp', 'telp_hp_koord', 'email_koord', 'jenis_pertanian',
    ...
    public function getKabTotal($kode_kab)
    {
        ...
        $row2   = $query2->getRow();
        $query3  = $db->query("select *, a.alamat, a.ketua, a.telp_hp, a.tgl_update, a.nama_bapel, b.jumpns, c.jumthl, d.jumswa, e.jumpok, f.jumgap, g.jumkep, h.nama_prop, i.nama_dati2, 
                                    case a.nama_bapel 
