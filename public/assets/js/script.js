$(document).on('click', '#btn-edit', function() {
    $('.modal-body #kecamatan').val($(this).data('deskripsi'));
    $('.modal-body #nm_desa').val($(this).data('nm_desa'));
    $('.modal-body #idpos').val($(this).data('idpos'));
    $('.modal-body #kode_desa').val($(this).data('kode_desa'));
    $('.modal-body #kode_kab').val($(this).data('kode_kab'));
    $('.modal-body #kode_kec').val($(this).data('kode_kec'));
